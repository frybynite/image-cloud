...
> ⚠️ **This will release a MAJOR version. Are you sure? Type 'confirmed' to continue.**

**DO NOT CONTINUE** until the user types exactly `confirmed`.
...
## Step 4 — Pre-release checklist review
