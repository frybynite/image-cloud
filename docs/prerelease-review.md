...
- [ ] **Grid jitter has outsized visual impact** — small jitter values produce more offset than users expect; fix the scaling or document the expected value range clearly
